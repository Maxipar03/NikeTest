...
const Footer = () => {
    ...
    return (
        <footer className="bg-white text-black flex justify-between items-center justify-items-center w-full px-12 py-5">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="135.5 361.38 1000 356.39">
            ...
            <div className="flex gap-4">
                ...
                <Link href="/stores" className="text-black hover:text-gray-600">Stores</Link>
            </div>
            <div className="flex flex-col space-y-4">
                <div className="flex space-x-4">
                    <Link href="https://www.instagram.com/nike/" target="_blank">
                    ...
                    <Link href="https://twitter.com/nike" target="_blank">
                        <FaTwitter className="text-2xl hover:text-gray-600e" />
                    </Link>
